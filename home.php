...
<html lang="en">
  ...
  <body ng-app="myApp">
    ...
    <div class="container">
      ...
      <br />
      <p>
        To find out more about Web Historians and how the process works, view
        our <a href="gettingstarted.php">Getting started</a> page.
      </p>
      <p>
        Want to dive right in?  Start a new project by choosing a
        website from one of the categories below.
      </p>
    </div>
